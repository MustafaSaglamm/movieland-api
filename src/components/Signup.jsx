  ...
  return (
    ...
    <div className='signupcard m-auto bg-black bg-opacity-90 rounded-lg'>
        <div className=' mx-5'>
            ...
            <h2 className='flex text-lg pt-5 '>Sign up for a free account</h2>
            <p className='flex text-lg gap-3 pt-2'>Already have an account yet? <Link className=' hover:scale-110 transition-all' to='/signin'>Sign In.</Link> </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className='signupform pt-5 mx-5 ' >
            ...
            <button className='text-white  bg-transparent border-2 rounded-3xl mt-5 w-full hover:bg-slate-100 hover:scale-105 hover:text-black transition-all' >Sign Up</button>
        </form>   
